...
class Model:
	...
	********************
	...
	def read_orders_date(self, date): #Caution with large amount of data
		try:
	...
	def read_orders_client(self, id_client): #Caution with large amount of data
		try:
