class View:
	...
	******************
	...
	def zips_menu(self):
		...
		print('4. Mostrar CPs de una cuidad')
	...
	**********************
	...
	def products_menu(self):
		...
		print('***************************')
		print('1. Agregar procducto')
		print('2. Leer procducto')
		print('3. Leer todos procductos')
	...
	********************
	...
	def orders_menu(self):
		...
		print('8. Modificar productos de un orden')
	...
	def show_order(self, record):
		...
		print(' Datos de cliente '.center(81,'*'))
